              ...
              <div class="pricing-table Starter-plan wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                  ...
                  <div class="pricing-table-foot">
                      <div class="plan-select">
                          <a href="https://portal.edropship.co.uk" class="filled-btn" target="_blank">Select Plan <i class="fas fa-arrow-right"></i></a>
                      </div>
                  </div>
              </div>
          </div>
                            ...
                            <div class="accordion" id="accordionFAQ">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionFAQ">
                                        <div class="accordion-body">
                                            <p>No. You can sign up and use the eDropShip portal without having to enter any payment details. Even if you opt for the premium services like Start Up or Enterprise package, you can enjoy free trial for a certain time period. </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionFAQ">
                                        <div class="accordion-body">
                                            <p>Yes, you can switch from one plan to another and upgrade or downgrade it any time. </p>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- /.accordion -->
